...
import org.springframework.cloud.openfeign.async.clientconfig.AsyncHttpClient5FeignConfiguration;
...
public class AsyncFeignAutoConfiguration {
	...
	@ConditionalOnProperty(value = "feign.httpclient.asyncHc5.enabled", havingValue = "true")
	@Import(AsyncHttpClient5FeignConfiguration.class)
	protected static class InnerAsyncHttpClient5FeignConfiguration {
	...
	protected static class DefaultAsyncFeignTargeterConfiguration {
		...
		public AsyncTargeter<HttpClientContext> asyncTargeter() {
