...
/**
 * A factory that creates instances of async feign classes. It creates a Spring
 * ApplicationContext per client name, and extracts the beans that it needs from there.
 *
 * @author Nguyen Ky Thanh
 */
public class AsyncFeignContext extends NamedContextFactory<AsyncFeignClientSpecification> {
	public AsyncFeignContext() {
