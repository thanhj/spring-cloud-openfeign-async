 ...
 */
public class AsyncFeignContextTest {
	@Test
	public void getInstanceWithoutAncestors_verifyNullForMissing() {
		AnnotationConfigApplicationContext parent = new AnnotationConfigApplicationContext();
		parent.refresh();

		AsyncFeignContext feignContext = new AsyncFeignContext();
	...
	private AsyncFeignClientSpecification getSpec(String name, Class<?> configClass) {
		return new AsyncFeignClientSpecification(name, new Class[] { configClass });
	}
