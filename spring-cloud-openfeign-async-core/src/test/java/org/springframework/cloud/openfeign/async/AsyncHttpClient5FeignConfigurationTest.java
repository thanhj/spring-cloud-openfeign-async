...
class AsyncHttpClient5FeignConfigurationTest {
	...
	void setUp() {
		context = new SpringApplicationBuilder()
				.properties("feign.httpclient.disableSslValidation=true", "feign.httpclient.asyncHc5.enabled=true")
				.web(WebApplicationType.NONE).sources(HttpClientConfiguration.class, AsyncFeignAutoConfiguration.class)
				.run();
	}
	...
	private Lookup<TlsStrategy> getTlsStrategyLookup(AsyncClientConnectionManager connectionManager) {
