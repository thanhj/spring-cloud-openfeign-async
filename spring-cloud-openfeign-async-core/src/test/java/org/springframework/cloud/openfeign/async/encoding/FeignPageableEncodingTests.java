...
package org.springframework.cloud.openfeign.async.encoding;
...
import org.springframework.cloud.openfeign.async.encoding.app.client.InvoiceClient;
...
public class FeignPageableEncodingTests {
	...
	@SpringBootApplication(scanBasePackages = "org.springframework.cloud.openfeign.async.encoding.app",
